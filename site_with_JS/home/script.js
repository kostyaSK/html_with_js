...
document.getElementById('searchButton').addEventListener('click', saveAndClearInput);
...
const arrowRight = document.getElementById('arrowActive');
const arrowLeft = document.getElementById('arrowNoActive');
...
function activeRightArrow() {
    ...
    setTimeout(() => {
        ...
        arrowRight.id = 'arrowNoActive';
        arrowLeft.id = 'arrowActive';
...
function activeLeftArrow() {
    ...
    setTimeout(() => {
        ...
        arrowRight.id = 'arrowActive';
        arrowLeft.id = 'arrowNoActive';
    }, 2000);
}
